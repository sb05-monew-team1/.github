...
<div align=left> 
  ...
  <img src="https://img.shields.io/badge/sonarqube cloud-126ED3?style=for-the-badge&logo=sonarqubecloud&logoColor=white">  
</div>
...
📰 **뉴스 기사 관리**
- 다양한 출처의 뉴스 수집 (Naver API, 한국경제 RSS, 조선일보 RSS, 연합뉴스 RSS)
- 뉴스 기사 정보 포함: 출처, 원본 링크, 제목, 날짜, 요약, 댓글, 관심사, 조회수
- 수집한 기사와 관심사의 키워드 연동
- 원본 링크 제공
- 기사 수집 시간 기록
- 날짜 단위 백업 기능 (AWS S3 연동)
- S3/DB 이중 저장으로 데이터 안정성 확보

🔍 **관심사 관리**
- 사용자별 관심사 설정 (이름, 키워드, 구독자 수)
- 80% 이상 유사한 관심사 자동 등록 방지
- 키워드 기반 뉴스 검색 활성화
- 관심사별 속성 데이터 검색 기능
- 관심사 삭제 가능

💬 **댓글 관리**
- 뉴스 기사별 댓글 등록 (사용자 정보, 내용, 날짜, 좋아요 수)
- 본인 작성 댓글만 수정 가능
- 댓글 삭제 기능 (논리 삭제, UI로 재생성 불가)
- 댓글별 좋아요/취소 기능
...
| 팀원 | 구현 기능 |
|------|----------|
| 김규섭 | 뉴스 기사 관련 API, Batch 작업 |
| 김수연 | 관심사 관련 API |
| 김준교 | 알림 관련 API, 사용자 활동 내역 관련 API, Batch 작업 |
| 박윤지 | 사용자 관련 API |
| 강동민 | 댓글 관련 API |
